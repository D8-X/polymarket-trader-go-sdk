...
func SplitPosition(ctx context.Context, eoa, privateKeyHex, depositWallet, conditionID string, amount *big.Int, creds *types.RelayerCredentials) (*types.RelayerResponse, error) {
...
func MergePositions(ctx context.Context, eoa, privateKeyHex, depositWallet, conditionID string, amount *big.Int, creds *types.RelayerCredentials) (*types.RelayerResponse, error) {
	if amount == nil || amount.Sign() <= 0 {
...
func RedeemPositions(ctx context.Context, eoa, privateKeyHex, depositWallet, conditionID string, creds *types.RelayerCredentials) (*types.RelayerResponse, error) {
	calls := []types.WalletCall{
