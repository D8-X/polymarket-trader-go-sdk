...
type ResolveOpts = models.ResolveOpts
type TradeResolution = models.TradeResolution
type BalanceEntry = models.BalanceEntry
type PositionEntry = models.PositionEntry
type PositionsOpts = models.PositionsOpts
type PositionsPage = models.PositionsPage
type PositionsPagination = models.PositionsPagination
type PositionStatus = models.PositionStatus
type PositionsSort = models.PositionsSort
